            ...
            <Dialog open={!!selectedCert} onOpenChange={(open) => {
                ...
                <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden flex flex-col p-0">
                    ...
                    <div className="px-6 py-4 border-b flex justify-between items-center bg-background/95 backdrop-blur z-10 shrink-0">
                      <div>
                        <DialogTitle className="font-heading text-xl text-amber-700 dark:text-amber-400 m-0">
                          {t('modal_review_cert')}
                        </DialogTitle>
                        {selectedCert && (
                    ...
                    {selectedCert && (
                      <div className="flex-1 overflow-hidden grid grid-cols-1 lg:grid-cols-2">
                        ...
                        <div className="overflow-y-auto p-6 lg:p-8 space-y-8 bg-background">
                            ...
                            <div className="grid grid-cols-2 gap-y-6 gap-x-4 text-sm bg-amber-500/5 p-5 rounded-xl border border-amber-500/20 shadow-sm relative overflow-hidden">
                                ...
                                <div>
                                    ...
                                    <StatusBadge status={getMidAuthorityStatus(selectedCert)} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-0">
                                  ...
                                  {selectedCert.approvalHistory?.length > 0 && (
                                     <div className="border-l-2 border-amber-500/30 ml-2 pl-4 py-2 relative">
                                        <div className="absolute -left-[5px] top-4 bg-amber-500 w-2 h-2 rounded-full" />
                                  ...
                                  {/* Mid (Self) */}
                                   {(selectedCert.seniorapprovalhistory?.length || 0) > 0 && (
                                     <div className="border-l-2 border-amber-500/30 ml-2 pl-4 py-2 relative">
                                        <div className="absolute -left-[5px] top-4 bg-blue-500 w-2 h-2 rounded-full ring-2 ring-background" />
                                        <p className="text-xs font-bold text-foreground">{t('modal_mid_level') || 'Mid Authority'}</p>
                            ...
                            {getMidAuthorityStatus(selectedCert) === 'pending' && (
                                <div className="pt-6 border-t mt-auto space-y-4">
                                    ...
                                    <div className="flex gap-3 pt-2">
                                        ...
                                        <Button size="lg" className="flex-1 bg-amber-600 hover:bg-amber-700" onClick={() => handleApprove(selectedCert)}>
